...
#define GSK_RECT_SNAP_FLOOR 1
#define GSK_RECT_SNAP_CEIL 2
#define GSK_RECT_SNAP_ROUND 3

#define GSK_RECT_SNAP_TOP_SHIFT 0
#define GSK_RECT_SNAP_RIGHT_SHIFT 8
#define GSK_RECT_SNAP_BOTTOM_SHIFT 16
#define GSK_RECT_SNAP_LEFT_SHIFT 24
#define GSK_RECT_SNAP_MASK 0xFF

/**
 * GskRectSnap:
 * @GSK_RECT_SNAP_NONE:
 * @GSK_RECT_SNAP_TOP_UP:
 * @GSK_RECT_SNAP_TOP_DOWN:
 * @GSK_RECT_SNAP_TOP_CLOSE:
 * @GSK_RECT_SNAP_RIGHT_LEFT:
 * @GSK_RECT_SNAP_RIGHT_RIGHT:
 * @GSK_RECT_SNAP_RIGHT_CLOSE:
 * @GSK_RECT_SNAP_BOTTOM_UP:
 * @GSK_RECT_SNAP_BOTTOM_DOWN:
 * @GSK_RECT_SNAP_BOTTOM_CLOSE:
 * @GSK_RECT_SNAP_LEFT_LEFT:
 * @GSK_RECT_SNAP_LEFT_RIGHT:
 * @GSK_RECT_SNAP_LEFT_CLOSE:
 * @GSK_RECT_SNAP_GROW:
...
typedef enum {
  ...
  GSK_RECT_SNAP_TOP_UP =       GSK_RECT_SNAP_FLOOR << GSK_RECT_SNAP_TOP_SHIFT,
  GSK_RECT_SNAP_TOP_DOWN =     GSK_RECT_SNAP_CEIL << GSK_RECT_SNAP_TOP_SHIFT,
  GSK_RECT_SNAP_TOP_CLOSE =    GSK_RECT_SNAP_ROUND << GSK_RECT_SNAP_TOP_SHIFT,
  GSK_RECT_SNAP_RIGHT_LEFT =   GSK_RECT_SNAP_FLOOR << GSK_RECT_SNAP_RIGHT_SHIFT,
  GSK_RECT_SNAP_RIGHT_RIGHT =  GSK_RECT_SNAP_CEIL << GSK_RECT_SNAP_RIGHT_SHIFT,
  GSK_RECT_SNAP_RIGHT_CLOSE =  GSK_RECT_SNAP_ROUND << GSK_RECT_SNAP_RIGHT_SHIFT,
  GSK_RECT_SNAP_BOTTOM_UP =    GSK_RECT_SNAP_FLOOR << GSK_RECT_SNAP_BOTTOM_SHIFT,
  GSK_RECT_SNAP_BOTTOM_DOWN =  GSK_RECT_SNAP_CEIL << GSK_RECT_SNAP_BOTTOM_SHIFT,
  GSK_RECT_SNAP_BOTTOM_CLOSE = GSK_RECT_SNAP_ROUND << GSK_RECT_SNAP_BOTTOM_SHIFT,
  GSK_RECT_SNAP_LEFT_LEFT =    GSK_RECT_SNAP_FLOOR << GSK_RECT_SNAP_LEFT_SHIFT,
  GSK_RECT_SNAP_LEFT_RIGHT =   GSK_RECT_SNAP_CEIL << GSK_RECT_SNAP_LEFT_SHIFT,
  GSK_RECT_SNAP_LEFT_CLOSE =   GSK_RECT_SNAP_ROUND << GSK_RECT_SNAP_LEFT_SHIFT,
  GSK_RECT_SNAP_GROW = GSK_RECT_SNAP_TOP_UP | GSK_RECT_SNAP_RIGHT_RIGHT | GSK_RECT_SNAP_BOTTOM_DOWN | GSK_RECT_SNAP_LEFT_LEFT,
  GSK_RECT_SNAP_SHRINK = GSK_RECT_SNAP_TOP_DOWN | GSK_RECT_SNAP_RIGHT_LEFT | GSK_RECT_SNAP_BOTTOM_UP | GSK_RECT_SNAP_LEFT_RIGHT,
  GSK_RECT_SNAP_CLOSE = GSK_RECT_SNAP_TOP_CLOSE | GSK_RECT_SNAP_RIGHT_CLOSE | GSK_RECT_SNAP_BOTTOM_CLOSE | GSK_RECT_SNAP_LEFT_CLOSE,
} GskRectSnap;
