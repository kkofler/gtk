...
#define GDK_MACOS_VULKAN_CONTEXT_CLASS(klass) 	(G_TYPE_CHECK_CLASS_CAST ((klass), GDK_TYPE_MACOS_VULKAN_CONTEXT, GdkMacosVulkanContextClass))
#define GDK_IS_MACOS_VULKAN_CONTEXT_CLASS(klass)	(G_TYPE_CHECK_CLASS_TYPE ((klass), GDK_TYPE_MACOS_VULKAN_CONTEXT))
#define GDK_MACOS_VULKAN_CONTEXT_GET_CLASS(obj)	(G_TYPE_INSTANCE_GET_CLASS ((obj), GDK_TYPE_MACOS_VULKAN_CONTEXT, GdkMacosVulkanContextClass))
